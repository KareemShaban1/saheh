...
use Modules\Clinic\OrganizationInventory\Http\Requests\Backend\StoreOrganizationInventoryRequest;
use Modules\Clinic\OrganizationInventory\Http\Requests\Backend\UpdateOrganizationInventoryRequest;
...
class OrganizationInventoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.dashboards.clinic.pages.organization-inventories.index');
    }
    ...
    public function data()
    {
        ...
        ->addColumn('movements' , function ($organizationInventory) {
            return '<a href="' . route('clinic.inventory-movements.index', $organizationInventory->id) . '">Movements</a>';
        })
    ...
    public function create()
    {
        ...
        return view('backend.dashboards.clinic.pages.organization-inventories.create');
    }
    ...
    public function store(StoreOrganizationInventoryRequest $request)
    {
        ...
        try {
            ...
            $validatedData['organization_type'] = Clinic::class;
    ...
    public function show(OrganizationInventory $organizationInventory)
    {
        ...
        return view('backend.dashboards.clinic.pages.organization-inventories.show', compact('organizationInventory'));
    }
