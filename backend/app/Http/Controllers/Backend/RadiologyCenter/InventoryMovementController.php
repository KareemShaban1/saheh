...
use App\Http\Requests\Backend\MedicalLaboratory\StoreInventoryMovementRequest;
use App\Http\Requests\Backend\MedicalLaboratory\UpdateInventoryMovementRequest;
...
class InventoryMovementController extends Controller
{
    ...
    public function index($inventoryId)
    {
        ...
        return view('backend.dashboards.medical-laboratory.pages.inventory-movements.index', compact('inventoryId'));
    }
    ...
    public function create()
    {
        ...
        return view('backend.dashboards.medical-laboratory.pages.inventory-movements.create');
    }
    ...
    public function show(InventoryMovement $inventoryMovement)
    {
        ...
        return view('backend.dashboards.medical-laboratory.pages.inventory-movements.show', compact('inventoryMovement'));
    }
