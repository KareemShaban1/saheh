...
use App\Http\Requests\Backend\RadiologyCenter\StoreOrganizationInventoryRequest;
use App\Http\Requests\Backend\RadiologyCenter\UpdateOrganizationInventoryRequest;
...
class OrganizationInventoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.dashboards.radiologyCenter.pages.organization-inventories.index');
    }
    ...
    public function data()
    {
        ...
        ->addColumn('movements' , function ($organizationInventory) {
            return '<a href="' . route('radiologyCenter.inventory-movements.index', $organizationInventory->id) . '">Movements</a>';
        })
    ...
    public function create()
    {
        ...
        return view('backend.dashboards.radiologyCenter.pages.organization-inventories.create');
    }
    ...
    public function store(StoreOrganizationInventoryRequest $request)
    {
        ...
        try {
            ...
            $validatedData['organization_type'] = RadiologyCenter::class;
    ...
    public function show(OrganizationInventory $organizationInventory)
    {
        ...
        return view('backend.dashboards.radiologyCenter.pages.organization-inventories.show', compact('organizationInventory'));
    }
