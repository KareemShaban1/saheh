...
class AnnouncementController extends Controller
{
    ...
    {
        //
        return view('backend.dashboards.radiologyCenter.pages.announcements.index');
    }
    ...
    public function store(StoreAnnouncementRequest $request)
    {
        ...
        return redirect()->route('radiologyCenter.announcements.index')->with('toast_success', 'Announcement created successfully');
    }
    ...
    public function update(UpdateAnnouncementRequest $request, $id)
    {
        ...
        return redirect()->route('radiologyCenter.announcements.index')->with('toast_success', 'Announcement updated successfully');
    }
    ...
    public function destroy(Request $request, $id)
    {
        ...
        return redirect()->route('radiologyCenter.announcements.index')->with('toast_success', 'Announcement deleted successfully');
    }
}
