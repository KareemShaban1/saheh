...
class RaysController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.dashboards.medicalLaboratory.pages.rays.index', compact('rays'));
    }
    ...
    public function data()
    {
        ...
        return DataTables::of(source: $query)
            ->addColumn('action', function ($ray) {
                $editUrl = route('medicalLaboratory.rays.edit', $ray->id);
                $deleteUrl = route('medicalLaboratory.rays.destroy', $ray->id);
                $showUrl = route('medicalLaboratory.rays.show', $ray->id);
    ...
    public function add($id)
    {
        ...
        return view('backend.dashboards.medicalLaboratory.pages.rays.add', compact('reservation'));
    }

    public function create()
    {
        $patients = Patient::medicalLaboratory()->get();
        return view('backend.dashboards.medicalLaboratory.pages.rays.create', compact('patients'));
    }
    ...
    public function store(StoreRayRequest $request)
    {
        ...
        try {
            ...
            return redirect()->route('medicalLaboratory.reservations.index')->with('toast_success', 'Reservation added successfully');
    ...
    public function show($id)
    {
        ...
        return view('backend.dashboards.medicalLaboratory.pages.rays.show', compact('rays'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.dashboards.medicalLaboratory.pages.rays.edit', compact('ray', 'images'));
    }
    ...
    public function update(UpdateRayRequest $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('medicalLaboratory.reservations.index')->with('toast_success', 'Reservation updated successfully');
        } catch (ValidationException $e) {
            return redirect()->back()->withErrors($e->errors())->withInput();
        } catch (\Exception $e) {
