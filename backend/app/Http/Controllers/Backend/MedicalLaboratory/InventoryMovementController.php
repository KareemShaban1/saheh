...
class InventoryMovementController extends Controller
{
    ...
    public function index($inventoryId)
    {
        ...
        return view('backend.dashboards.medicalLaboratory.pages.inventory-movements.index', compact('inventoryId'));
    }
    ...
    public function create()
    {
        ...
        return view('backend.dashboards.medicalLaboratory.pages.inventory-movements.create');
    }
    ...
    public function show(InventoryMovement $inventoryMovement)
    {
        ...
        return view('backend.dashboards.medicalLaboratory.pages.inventory-movements.show', compact('inventoryMovement'));
    }
