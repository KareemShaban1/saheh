...
class EventController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.dashboards.medicalLaboratory.pages.events.index', compact('events'));
    ...
    public function data()
    {
        ...
        return DataTables::of($events)
            ->addColumn('action', function ($event) {
                ...
                $deleteUrl = route('medicalLaboratory.events.destroy', $event->id);
    ...
    {
        return view('backend.dashboards.medicalLaboratory.pages.events.show');
    }
    ...
    public function trash()
    {
        ...
        return view('backend.dashboards.medicalLaboratory.pages.events.trash', compact('events'));
    }
