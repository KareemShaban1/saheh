        ...
        <nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
                  ...
                  <!-- logo -->
                  <div class="text-left navbar-brand-wrapper w-[230px] !important text-center">
                  ...
                  <!-- top bar right -->
                  <ul class="nav navbar-nav mr-auto left-nav">
                            <div class="btn-group mb-1">
                                      <button type="button" class="btn btn-light btn-sm dropdown-toggle lang-btn"
                            ...
                            <x-backend.org-notification-menu count="7" />
                            ...
                            <li class="nav-item dropdown mr-30">
                                      ...
                                      <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a class="dropdown-item" href="{{ Route('clinic.settings.index') }}"><i
