                ...
                <form class="login100-form validate-form" method="POST" action="{{ Route('login') }}">
                    ...
                    <div class="demo-credentials p-t-20 p-b-10" style="margin-top: 24px; padding: 16px; background: rgba(0,0,0,0.03); border-radius: 8px; border: 1px solid rgba(0,0,0,0.06);">
                        ...
                        <div style="font-size: 12px; color: #555; line-height: 1.8;">
                            <strong>Admin:</strong> admin@clinic1.com<br>
                            <strong>Doctor:</strong> doctor1@clinic1.com<br>
                            <strong>Staff:</strong> user1@clinic1.com<br>
                            <span style="margin-top: 6px; display: block;"><strong>Password for all:</strong> password</span>
                            <div style="margin-top: 10px; padding-top: 10px; border-top: 1px solid rgba(0,0,0,0.08); font-size: 11px; color: #666;">Try other dashboards: Medical Lab — admin@lab1.com | Radiology — admin@radiology1.com</div>
                        </div>
                    </div>
