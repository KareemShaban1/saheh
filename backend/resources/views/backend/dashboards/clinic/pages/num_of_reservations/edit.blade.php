		...
		<div class="card card-statistics h-100">
			<div class="card-body">
				...
				<form method="post" enctype="multipart/form-data"
					action="{{Route('clinic.reservation_numbers.update',$num_of_res->id)}}"
					autocomplete="off">
					@csrf
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input class="form-control"
									value="{{ old('reservation_date', $num_of_res->reservation_date) }}"
						...
						<div class="col-lg-6 col-md-6 col-sm-12">
							<div class="form-group">
								...
								<input class="form-control" type="text"
									...
									value="{{ old('num_of_reservations', $num_of_res->num_of_reservations) }}">
							</div>
						</div>
