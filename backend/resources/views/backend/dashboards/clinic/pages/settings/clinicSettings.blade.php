...
@endsection
@section('page-header')
<h4 class="page-title"> {{ trans('backend/settings_trans.Clinic Settings') }}</h4>
        ...
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <form method="post" enctype="multipart/form-data"
                    action="{{ Route('clinic.settings.clinicSettings.update') }}" autocomplete="off">
                    @csrf
                    {{-- @method('PUT') --}}
                    <div class="row mb-4">
                        <div class="col-lg-3 col-md-4 col-sm-6 col-5">
                            <h5 class="setting-title">{{ trans('backend/settings_trans.Doctor_Name') }}<span
                    ...
                    <div class="row mb-4">
                        <div class="col-lg-3 col-md-4 col-sm-6 col-5">
                            <h5> {{ trans('backend/settings_trans.Doctor_Address') }} <span class="text-danger">*</span>
                            </h5>
                        </div>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-lg-6 col-md-8 col-sm-6 col-7">
                            <select name="clinic_type" class="custom-select mr-sm-2">
                                <option value="" @selected(isset($settings['clinic_type']) && $settings['clinic_type']=='' )> </option>
                                <option value="عيون" @selected(isset($settings['clinic_type']) && $settings['clinic_type']=='عيون' )> عيون</option>
                                <option value="أسنان" @selected(isset($settings['clinic_type']) && $settings['clinic_type']=='أسنان' )> أسنان</option>
                                <option value="جلدية" @selected(isset($settings['clinic_type']) && $settings['clinic_type']=='جلدية' )> جلدية</option>
                            </select>
