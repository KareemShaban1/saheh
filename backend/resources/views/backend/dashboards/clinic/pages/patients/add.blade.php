    ...
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <form method="post" enctype="multipart/form-data" action="{{ Route('clinic.patients.store') }}"
                    autocomplete="off">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                                <label for="doctor_id">{{ trans('backend/patients_trans.Doctor') }}<span class="text-danger">*</span></label>
                                <select name="doctor_ids[]" id="doctor_id" class="form-control select2" multiple>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" id="whatsapp_number" name="whatsapp_number" type="phone">
