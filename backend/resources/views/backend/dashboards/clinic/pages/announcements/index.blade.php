...
<x-modal id="addAnnouncementModal" title="{{__('Add Announcement')}}">
    <form id="addAnnouncementForm" method="POST" action="{{ route('clinic.announcements.store') }}">
        @csrf
...
<script>
    $(function() {
        ...
        var table = $('#announcements-table').DataTable({
            ajax: "{{ route('clinic.announcements.data') }}",
            columns: [{
                    data: 'id',
                    name: 'id'
                },
    ...
    function editAnnouncement(id) {
        $.get('{{ route("clinic.announcements.index") }}/edit/' + id, function(data) {

            console.log(data);
            $('#editAnnouncementModal').modal('show');
            $('#editAnnouncementForm').attr('action', '{{ route("clinic.announcements.update", "") }}/' + id);
    ...
    function deleteAnnouncement(id) {
        ...
        $.ajax({
            url: '{{ route("clinic.announcements.delete", "") }}/' + id,
            type: 'DELETE',
            headers: {
                'X-Requested-With': 'XMLHttpRequest',
