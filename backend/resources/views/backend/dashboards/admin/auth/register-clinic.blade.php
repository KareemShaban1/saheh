    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100">
                ...
                <form method="POST" action="{{ Route('store-clinic') }}">
                    @csrf   
                    ...
                    <div class="col-md-12">
                            <div class="form-group">
                                <label>{{ trans('frontend/auth_trans.Name') }}</label>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label> {{ trans('frontend/auth_trans.Email') }}</label>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>{{ trans('frontend/auth_trans.Address') }}</label>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>{{ trans('frontend/auth_trans.Phone') }}</label>
