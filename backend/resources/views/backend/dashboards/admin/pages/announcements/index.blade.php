...
<x-modal id="addAnnouncementModal" title="{{__('Add Announcement')}}">
    <form id="addAnnouncementForm" method="POST" action="{{ route('admin.announcements.store') }}">
        @csrf
    ...
    <form id="editAnnouncementForm" method="POST">
        ...
        <div class="modal-body">
            ...
            <div class="mb-3">
                ...
                <input type="checkbox" class="form-check-input" id="edit_send_notification" name="send_notification" checked>
                <div class="invalid-feedback"></div>
            </div>
            <div class="mb-3">
...
<script>
    ...
    function editAnnouncement(id) {
        $.get('{{ route("admin.announcements.index") }}/edit/' + id, function(data) {

            $('#editAnnouncementModal').modal('show');
            $('#editAnnouncementForm').attr('action', '{{ route("admin.announcements.update", "") }}/' + id);
