...
<x-modal id="addAnnouncementModal" title="{{__('Add Announcement')}}">
    <form id="addAnnouncementForm" method="POST" action="{{ route('radiologyCenter.announcements.store') }}">
        @csrf
...
<script>
    $(function() {
        ...
        var table = $('#announcements-table').DataTable({
            ajax: "{{ route('radiologyCenter.announcements.data') }}",
            columns: [{
                    data: 'id',
                    name: 'id'
                },
    ...
    function editAnnouncement(id) {
        $.get('{{ route("radiologyCenter.announcements.index") }}/edit/' + id, function(data) {

            console.log(data);
            $('#editAnnouncementModal').modal('show');
            $('#editAnnouncementForm').attr('action', '{{ route("radiologyCenter.announcements.update", "") }}/' + id);
    ...
    function deleteAnnouncement(id) {
        ...
        $.ajax({
            url: '{{ route("radiologyCenter.announcements.delete", "") }}/' + id,
            type: 'DELETE',
            headers: {
                'X-Requested-With': 'XMLHttpRequest',
