    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-register100">
                <form class="login100-form validate-form" method="POST" action="{{ Route('register-radiology-center') }}" id="radiologyCenterRegistrationForm">
                    @csrf
                    <span class="login100-form-title p-b-26">
                        {{ __('Register Radiology Center') }}
                    </span>

                    <div id="stepper">
                        <!-- Step 1: Radiology Center Details -->
                        <div class="step step-1">
                            <h4 class="register-step-1">{{ __('Step 1: Radiology Center Information') }}</h4>

                            <div class="form-group">
                                <label class="form-label required">{{ __('Radiology Center Name')}}</label>
                                <input type="text" name="radiology_center_name" class="form-control @error('radiology_center_name') is-invalid @enderror" value="{{ old('radiology_center_name') }}" required>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="radiology_center_email" class="form-control @error('radiology_center_email') is-invalid @enderror" value="{{ old('radiology_center_email') }}" required>
    ...
    <script>
        ...
        $(document).ready(function() {
            $(".next-step").click(function() {
                ...
                let emailField = $('input[name="radiology_center_email"]');
            ...
            $('#radiologyCenterRegistrationForm').submit(function(e) {
                e.preventDefault();
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            $('#radiologyCenterRegistrationForm')[0].reset();
                            $(".step-2").addClass("d-none");
                            $(".step-1").removeClass("d-none");
                        } else {
