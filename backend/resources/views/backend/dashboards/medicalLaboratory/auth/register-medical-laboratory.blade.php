    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-register100">
                <form class="login100-form validate-form" method="POST" action="{{ Route('register-medical-laboratory') }}" id="medicalLabRegistrationForm">
                    @csrf
                    ...
                    <div id="stepper">
                        ...
                        <div class="step step-1">
                            <h4 class="register-step-1">{{ __('Step 1: Medical Laboratory Information') }}</h4>
                            <div class="form-group">
                                <label class="form-label required">{{ __('Medical Laboratory Name')}}</label>
                                <input type="text" name="medical_laboratory_name" class="form-control @error('medical_laboratory_name') is-invalid @enderror" value="{{ old('medical_laboratory_name') }}" required>
                                @error('medical_laboratory_name')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="medical_laboratory_email" class="form-control @error('medical_laboratory_email') is-invalid @enderror" value="{{ old('medical_laboratory_email') }}" required>
                                        @error('medical_laboratory_email')
                                            <div class="error-message">{{ $message }}</div>
                                        @enderror
                                    </div>
                                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            $(".next-step").click(function() {
                ...
                let emailField = $('input[name="medical_laboratory_email"]');
            ...
            $('#medicalLabRegistrationForm').submit(function(e) {
                e.preventDefault();
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            $('#medicalLabRegistrationForm')[0].reset();
                            $(".step-2").addClass("d-none");
                            $(".step-1").removeClass("d-none");
                        } else {
