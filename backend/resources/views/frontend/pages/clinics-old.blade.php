...
<section class="bg-gradient-to-r from-blue-600 to-blue-800 py-20 mt-10">
	<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
		<div class="text-center">
			<h1 class="text-5xl font-bold text-white mt-10">Our Clinics</h1>
			...
			<div class="flex justify-center">
				<a href="#clinics"
					...
					View All Clinics <i class="fas fa-arrow-down ml-2"></i>
				</a>
			</div>
		</div>
	</div>
...
<section id="clinics" class="py-20">
	<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
			...
			<div
				...
				<div class="p-6">
					...
					<p class="text-gray-600 mb-4 line-clamp-3">
						{{ Str::limit($clinic->description, 120) }}</p>

					<div class="space-y-2 mb-4">
						<div class="flex items-center text-gray-600 gap-2">
							<i
								class="fas fa-map-marker-alt mr-2 text-blue-600"></i>
							<span class="text-sm">{{ $clinic->address }},
								{{ $clinic->area->name ?? '' }}</span>
						</div>
						<div class="flex items-center text-gray-600 gap-2">
						...
						<div class="flex items-center text-gray-600 gap-2">
							...
							<span class="text-sm">{{ $clinic->doctors->count() }}
								Doctors Available</span>
						</div>
					</div>
					...
					<div class="flex items-center justify-between">
						<div class="flex items-center">
							...
							<span class="text-sm text-gray-600">({{ $clinic->reviews->count() }}
								reviews)</span>
						</div>
						<span
				...
				<div class="px-6 pb-6">
					<div class="flex space-x-3">
						<a href="{{ route('clinic.detail', $clinic->id) }}"
		...
		<div class="text-center py-16">
			...
			<h3 class="text-2xl font-semibold text-gray-900 mb-4">No Clinics Available</h3>
			...
			<a href="{{ route('register-clinic') }}"
				...
				<i class="fas fa-plus mr-2"></i> Register Your Clinic
			</a>
		</div>
		@endif
	</div>
...
<section class="bg-gray-50 py-16">
	<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
		<div class="text-center">
			...
			<p class="text-xl text-gray-600 mb-8">Are you a healthcare provider? Register your clinic
			...
			<div class="flex flex-col sm:flex-row gap-4 justify-center">
				<a href="{{ route('register-clinic') }}"
					...
					<i class="fas fa-hospital mr-2"></i> Register Clinic
				</a>
				<a href="#contact"
