...
// clinic management
  ...
  { label: "Drugs", labelKey: "clinic.menu.drugs", to: "/clinic-dashboard/drugs", icon: FileText, permissionPrefixes: ["drugs"] },
  { label: "Questionnaires", labelKey: "clinic.menu.questionnaires", to: "/clinic-dashboard/questionnaires", icon: FileText, permissionPrefixes: ["questionnaires"] },
  ...
  { label: "Media Module", to: "/clinic-dashboard/media", icon: Puzzle },
...
{ label: "Patients", labelKey: "lab.menu.patients", to: "/lab-dashboard/patients", icon: Users, permissionPrefixes: ["patients"] },
  { label: "Questionnaires", to: "/lab-dashboard/questionnaires", icon: FileText, permissionPrefixes: ["questionnaires"] },
  { label: "Chat", to: "/lab-dashboard/chat", labelKey: "lab.menu.chat", icon: MessageCircle, permissionPrefixes: ["chat", "chats"] },
  { label: "Media Module", to: "/lab-dashboard/media", icon: Puzzle },
...
const radioItems: DashboardItem[] = [
  ...
  { label: "Questionnaires", to: "/radiology-dashboard/questionnaires", icon: FileText, permissionPrefixes: ["questionnaires"] },
  ...
  { label: "Media Module", to: "/radiology-dashboard/media", icon: Puzzle },
